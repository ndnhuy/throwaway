import { AxisBottom, AxisRendererProps } from "@visx/axis";
import AxisRenderer from "@visx/axis/lib/axis/AxisRenderer";
  ...
  return (
    <svg width={width} height={height}>
      ...
      <Group left={horizontalMargin / 2} top={verticalMargin / 2}>
        ...
        <AxisBottom
          scale={xScale}
          label="22Letter (English)"
          top={yMax}
          numTicks={data.length}
          left={xScale.bandwidth() / 2}
          children={(renderProps: AxisRendererProps<any>) => {
            ...
            return (
              <AxisRenderer
                ...
                tickPosition={(v) => {
                  ...
                  return renderProps.tickPosition(v);
                }}
              />
            );
          }}
